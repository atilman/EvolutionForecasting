...
np.save('../FIGS/SIFig6b-FitnessTest.npy', D)
...
Data = np.load('../FIGS/SIFig6b-FitnessTest.npy',allow_pickle=True)
MyoFit = Data[0]
fit_eq = Data[1]
eps1 = Data[2]
T1 = Data[3]
...
save = 'yes'
if save =='yes':
    fig1.savefig('../FIGS/SIFig6b.png',dpi=100, bbox_inches='tight')
