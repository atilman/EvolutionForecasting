...
if save=='yes' and final != 'yes':
    ...
    fig1.savefig('../FIGS/SIFig10a-dynamics.png',dpi=300,bbox_extra_artists=(pars1,), bbox_inches='tight')
    fig2.savefig('../FIGS/SIFig8a.png',dpi=300,bbox_extra_artists=(pars1,), bbox_inches='tight')
if save=='yes' and final == 'yes':
        fig1.savefig('../FIGS/SIFig10a-dynamics.png',dpi=300, bbox_inches='tight')
        fig2.savefig('../FIGS/SIFig8a.png',dpi=100, bbox_inches='tight')
#%%
...
if save == 'yes':
    fig3.savefig('../FIGS/SIFig9a.png',dpi=100, bbox_inches='tight')
